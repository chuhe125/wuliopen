...
<body>
    <div style="width:556px;margin:0 auto;padding:0 100px">
        ...
        <div><img src="https://gitee.com/cml_1_0/img/raw/master/20210922105332.png" class="one" style="margin-left:175px;"
            ></div>
        <div style="text-indent: 2rem;">电表的扩程,是利用不同的分流电阻与表头并联,达到扩大量程的目的.设电流表头原量程为Ig,内阻为Rg,扩程后的量程为I,则分流电阻由式①决定.</div>
        <div><img src="https://gitee.com/cml_1_0/img/raw/master/20210922112518.png" class="one" style="margin-left:175px;"></div>
        ...
        <div><img src="https://gitee.com/cml_1_0/img/raw/master/20210922105630.png" class="one" style="margin-left:175px;"></div>
        <div style="text-indent: 2rem;"> 直流电压档的改装,是利用不同的分压电阻与表头串联,达到改装的目的.电流表配上附加电阻Rf的数值由式②决定.</div>
        <div><img src="https://gitee.com/cml_1_0/img/raw/master/20210922112555.png" class="one" style="margin-left:175px;"></div>
        ...
        <h3>七、思考题(<span>每题十分</span>) 分数:{{$grade_xp}}</h3>
