...
<body>
    <div style="margin: 0 auto; width: 655px;">
        ...
        <img src="https://gitee.com/adya/images/raw/master/img/电桥平衡1.png "
            style="margin-right: 60px;margin-left: 160px; padding-bottom: 7px; ">
        ...
        <div style="text-indent: 2em; ">式中，σR1、σR2、σR0分别是R1，R2，R0的不确定度。为消除R1 ⁄
        ...
        <table cellspacing="0" style="width: 655px; border-bottom: none; ">
            <tr style="border-right: none;">
                <td colspan="7 "
                    style="height: 63px; margin-right: 50px; font-size: 25px; font-weight: 500; border-right: none; ">
                    1.箱式直流电桥测量电阻值</td>
            </tr>
            <tr>
                <th style="width: 176px;height: 79px;">
                    ...
                    <span
                        style="border-bottom: 1px solid black;display:block;transform: rotate(22.5deg);-o-transform: rotate(-155.5deg);-moz-transform: rotate (22.5deg);-webkit-transform: rotate(-155.5deg);width: 197px;margin-left: -10px;;position: absolute;"></span>
            ...
            <tr style="height: 50px; text-align: center; ">
                ...
                <th rowspan="3 " style="width: 64px; word-wrap:break-word; word-break:break-all;">{{$rx}}</th>
        ...
        <table cellspacing="0" style="width: 655px; border-top: none;border-bottom: none; ">
            ...
            <tr>
                ...
                <th>2</th>
                <th>3</th>
                <th colspan="2" style="width: 157px;border-right: none; ">测量结果</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>电阻臂R0(Ω)</td>
                ...
                <th rowspan="4 " style="width: 64px;border-right: none; word-wrap:break-word; word-break:break-all;">
                    {{$s}}</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>变化量ΔR0(Ω)</td>
        ...
        <h3>八、 判断题<span style="color: red; ">（每题5.5分，一共11分）</span></h3>
