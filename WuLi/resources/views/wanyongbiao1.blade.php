<DOCTYPE html>
    ...
    <div style="width:556px;margin:0 auto;padding:0 100px">
        ...
        <h3>七、思考题 得分:{{$grade_xp}}<p style="display:inline;font-size: 15px;color: rgb(233, 47, 47)">（每题10分，一共20分）</h3>
        <p>
        ...
        <p style="display:inline;">
            2.下列有关比例臂的说法中，正确的是（）
            <br>A.自组式直流电桥的比例臂可以随意选取
            <br>B.自组式直流电桥的比例臂不可以选取10:1
            <br>C.自组式直流电桥的比例臂可以选取1:1
        ...
        <br>
        &nbsp; 2.在实验过程中，只需要使用一个滑线变阻器。<p style="display:inline;font-size: 15px;color: rgb(233, 47, 47)">答案:{{$pd2}}</p><br>
