...
<body>
    <div style="width:556px;margin:0 auto;padding:0 100px">
        ...
        <div style="width: 655px;margin: 15px auto;text-indent: 2em;">示波器扫描信号的周期，实际上是以时基单位(时间/DIV)来标示的。测量中，待测信号的周期可表示为:
            <div style="width:100%;text-indent: 2em;text-align: center;margin: 15px;">Tx=时基单位×波形厘米数</div>
            <div style="width: 655px;margin: 0px;text-indent: 7ex;"> 式中波形厘米数为信号一个整周期的读数。</div>
            <div style="width: 655px;margin: 0px;text-indent: 2ex;">信号频率则是信号周期的倒数，即：</div>
            <h4 style="margin: 15px auto;text-align: center;">fx=1/Tx</h4>
            </div>

        <h4>3.	用李萨如图形测信号的频率</h4>

        <div style="width: 655px;margin: 15px auto;text-indent: 2em;">将不同的信号分别输入到CH2(信号发生器产生的已知信号fy)和CH1(待测信号源产生的未知信号fx)的输入端，当两个信号的频率满足一定的关系时，在荧光屏上将显示出李萨如图形，可用测量李萨如图形的相位参数或波形的切点数来测量时间参数。两正交正弦信号波形的相位差一定，频率比为一个有理数时，合成的圆形是一条稳定的闭合曲线。两信号的频率比与图形的切点数之间有下列
关系：</div>

        <img src ='https://gitee.com/i-lift-my-hair/image/raw/master/FyFx.png' style="position: relative;margin: auto;display: block;">
        ...
        <h4>表1：测量示波器自带校准方波信号的周期/频率（每空2分共14分）分数:{{$grade_tk}}</h4>
        <table border ="1" cellpadding="5" cellspacing="0" style="margin: 10px auto;min-width: 495px;">
            ...
            <tr>
                <td style="text-align: center;"><strong>校准信号频率(Hz)</strong></td>
        ...
        <table border ="1" cellpadding="5" cellspacing="0" style="margin: 10px auto;min-width: 495px;">
            ...
            <tr>
                ...
                <td style="text-align: center;"><img   src = "https://gitee.com/zj095/cloudimg/raw/master/202111092019535.png" ></td>
                <td style="text-align: center;"><img   src = "https://gitee.com/zj095/cloudimg/raw/master/202111092020818.png" ></td>
                <td style="text-align: center;"><img   src = "https://gitee.com/zj095/cloudimg/raw/master/202111092020589.png"></td>
            </tr>
            <tr>
        ...
        <h3>七、选择题（每选项2分，共20分）选择加判断分数:分数:{{$grade_xp}}</h3>
