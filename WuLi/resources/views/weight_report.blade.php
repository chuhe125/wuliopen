...
<div style="margin: 0 auto; width: 655px;">
    ...
    <h3>五、 实验内容与步骤 分数:{{$grade_tk}}</h3>
    <div style="height: 63px; margin-right: 50px; font-size: 25px; font-weight: 400; "> 1. 单摆法测重力加速度实验数据记录处理表</div>
    ...
    <div style="height: 63px; margin-right: 50px; font-size: 25px; font-weight: 400; "> 2.有效数处理与误差计算</div>
    <table border="1 " cellspacing="0 " style="width: 675px; " class="two ">
        <tr>
            <th>误差类别</th>
            <th>误差计算项</th>
