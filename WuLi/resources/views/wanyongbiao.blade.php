    ...
    <body>
        ...
        <div style="width:556px;margin:0 auto;padding:0 100px">
            ...
            <p>
                ...
                <p style="display:inline;font-size: 15px;">（分数：）
                </p>
                <p>
                    ...
                    <p>
                        3)调零电阻计算（理论值）
                        <P>
                            &nbsp; &nbsp; &nbsp;&nbsp;①根据电路图，仅闭合转换开关3，短接红黑表笔，此时调零电阻计算公式为:R4=R4=E/Im-Rn
                        </P>
                        <P>
...
<p>
            <table border="1" cellpadding="10" cellspacing="0" >
                ...
                <tr >
                    <td rowspan="3" width="150px">电流档的扩展设计</td>
                    <td  width="100px">改装要求</td>
                    <td colspan="3" >量程Im=10mA</td>
                    <td rowspan="3" width="150px">表头指针偏转描述：<br> &nbsp; &nbsp; &nbsp;用改装好的电流档测量电流时，<br>表头指针向右偏转，读数为{{$thr_one_ds}},<br>用此读数除以10再乘以改装后的电流表量程10mA，即为所测电流Ix的大小。</td>
                </tr>

                <tr >
                    <td>改装计算</td>
                    <td width="80px">分流电阻R1=</td>
                    <td >{{$thr_one_r1}}</td>
                    <td >Ω</td>
                </tr>
                <tr>
...
<tr>
                <td rowspan="3">电压档的改装设计</td>
                <td>改装要求</td>
                <td colspan="3">量程Vm=5V</td>
                <td rowspan="3">表头指针偏转描述：<br> &nbsp; &nbsp; &nbsp; 用改装好的电压档测量电流时，<br>表头指针向右偏转，读数为{{$thr_two_ds}},<br>用此读数除以20再乘以改装后的电压表量程5V，即为所测电压Vx的大小。
                </td>
                </tr>
                ...
                <tr>
                    <td rowspan="4">欧姆档的改装设计</td>
                    <td>改装要求</td>
                    <td colspan="3">量程比率×1Ω</td>
                    <td rowspan="4">表头指针偏转描述：<br> &nbsp; &nbsp; &nbsp; 用改装好的电阻档测量电流时，<br>表头指针向左偏转，读数为{{$thr_thr_ds}},<br>用此读数乘以250改装后的电阻表量程比率，即为所测电阻的大小。
                    </td>
                </tr>
