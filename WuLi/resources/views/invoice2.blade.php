    ...
    <div style="margin: 0 auto; width: 655px;">
        ...
        <table cellspacing="0" style="width:655px; border-top: none;border-bottom: none; ">
            ...
            <tr style="height: 50px; text-align: center; ">
                ...
                <td>10</td>
                <td>0.1</td>
                <th rowspan="3 " colspan="3" style="width: 64px; word-wrap:break-word; word-break:break-all;">RX=Ω</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>电阻臂R0(Ω)</td>
        ...
        <table cellspacing="0" style="width:655px; border-top: none; ">
            ...
            <tr style="height: 50px; text-align: center;">
                ...
                <th rowspan="4 " colspan="3" style="width: 64px; word-wrap:break-word; word-break:break-all;">RX=</th>
            </tr>
            <tr style="height: 50px; text-align: center;">
                <td>偏转格数Δn</td>
                <td>1</td>
