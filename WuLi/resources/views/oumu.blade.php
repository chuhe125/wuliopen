...
<body>
    <div>
        ...
        <div>
            <table border="1" cellspacing="0" style="height:200px; width: 600px;">
                <tr>
                    ...
                    <td rowspan="4" valign="top">Rx表头测量数据截图,要求<br>将
                        Rx读数标记在图上
                        (<span style="color: skyblue;">5分</span>)
                        <div style="width: 190px; height: 157px;">
                            <img src="{{$p1}}"
                                style="height: 160px;width: 150px;" class="jietu">
                        </div>
                    </td>
        ...
        <table border="1" cellspacing="0" style="height:400px;width:600px; margin-top: 15px;">
            <tr>
                <td valign="top">实验电路连线截图(<span style="color: skyblue;">15分</span>)
        ...
        <div style="text-align: center;">
            <img src="http://pengxingyi.oss-cn-beijing.aliyuncs.com/2021-11/13/3333phpGzBGum1636792508211113.png">
        </div>
        <p>A.测量阻值不同的电阻时必须重新调零</p>
        <p>B.测量电路中的某个电阻，不需要把该电阻与电路断开</p>
        <p>c.测量电阻时，为了使测量准确，应当尽量使指针指在中心刻度的附近</p>
        <p>D.如图为某同学的实验测量结果，指针在a位置处表示被测电阻的阻值为50Ω</p>
         <p>答案:{{$pd1}}</p>
        <p> 2. 把一个量程为5mA的电流表改装成欧姆表Rx1档,电流表的内阻是502,电池的电动势是1.5v,经过调零之后测电阻,当欧姆表指针指到满偏的3/4位置时,被测电阻的阻值是。</p>
        <p>A.50Ω</p>
        <p>B.100Ω</p>
        <p>c.16.7Ω</p>
        <p>D.400</p>
        ...
        <p>A.刻度盘上的刻度是均匀的</p>
        <p>B.指针指在最左边,表示待测电阻为零</p>
        <p>C.指针指在最左边,表示待测电阻为无穷大</p>
        <p>D.欧姆表可以精确的测量电阻</p>
        <p>答案:{{$pd3}}</p>
    </div>
</body>
