...
<body>
    <div style="width:556px;margin:0 auto;padding:0 100px">
        ...
        <div style="display: flex;position: relative;height: 60px;border-bottom: 1px solid #464545;">
            ...
            <span
                ...
                style="position: absolute;left: 50%;top:50%;height: 50%;transform: translate(-50%,-50%);color: #898989;font-size: 14px;">《{{$experiment_name}}》学生实验报告</span>
    ...
    <div style="margin: 0 auto; width: 655px;">
        ...
        <!--<h3>六、 实验数据记录与处理</h3>-->
        <h3>六、 实验数据记录与处理测试<font color="red">得分:{{$grade_tk}}</font></h3>
        <!-- 第一个 -->
        ...
        <table cellspacing="0" style="width:655px; border-top: none;border-bottom: none; ">
            ...
            <tr style="height: 50px; text-align: center; ">
                ...
                <td>10</td>
                <td>0.1</td>
                <th rowspan="3 " colspan="3" style="width: 64px; word-wrap:break-word; word-break:break-all;">RX=____Ω</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>电阻臂R0(Ω)</td>
        ...
        <table cellspacing="0" style="width:655px; border-top: none; ">
            ...
            <tr style="height: 50px; text-align: center;">
                ...
                <th rowspan="4 " colspan="3" style="width: 64px; word-wrap:break-word; word-break:break-all;">S=____</th>
            </tr>
            <tr style="height: 50px; text-align: center;">
                <td>偏转格数Δn</td>
                <td>1</td>
    ...
    <h3>七、 思考题<span style="color: red; ">（每题10分，一共20分）思考题加判断题得分:{{$grade_xp}}</span></h3>
