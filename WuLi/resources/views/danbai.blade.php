...
<div style="margin: 0 auto; width: 655px;">
    ...
    <div style="display: flex;position: relative;height: 60px;border-bottom: 1px solid #464545;">
        ...
        <!--</div>-->
        <span style="position: absolute;left: 50%;top:50%;height: 50%;transform: translate(-50%,-50%);color: #898989;font-size: 14px;">《{{$experiment_name}}》学生实验报告</span>
    </div>
    <div style="margin: 0 auto;text-align: center;padding-bottom: 20px;padding-top: 3px;">
        <span style="font-size: 23px;">《{{$experiment_name}}》学生实验（项目）报告</span>
    </div>
    <br>
    ...
    <h2 style="text-align: center;">实验项目：单摆法测重力加速度</h2>
    <!-- 实验目的 -->
    <h3>一、 实验目的</h3>
    <div style="text-indent: 2em; width: 655px; ">
        <div>1. 学习物理实验仿真软件的使用。</div>
        <div>2. 掌握游标卡尺等工具的认读与使用，掌握单摆法测重力加速度的方法。</div>
        <div>3. 掌握实验数据处理方法。</div>
    </div>
    <!-- 实验仪器与设备 -->
    <h3>二、 实验仪器与设备</h3>
    <div style="text-indent: 2em; width: 655px; ">
    ...
    <table style="border-bottom: 1px solid black;">
        ...
        <tr style="height: 210px;">
            <td>
                <div>2、数据处理 </div>
                <div>1）有效数字及运算</div>
                <div style="text-indent: 2em; color: red;">有效数字的概念:若干位可靠数字加一位可疑数字，便组成了有效数字。掌握有效数字的加减乘除的运算规则。</div>
                <div>2）误差及运算</div>
    ...
    <!-- 分数:{{$grade_tk}} -->
    <h3>五、 实验内容与步骤</h3>
    <div style="height: 63px; margin-right: 50px; font-size: 20px; font-weight: 400; "> 1. 单摆法测重力加速度实验数据记录处理表</div>
    <table border=" 1 " cellspacing="0 " style="width: 675px; " class="two ">
        ...
        <tr style="height: 67px; ">
            ...
            <td style="width:39px; word-wrap:break-word; word-break:break-all; "></td>
            <td>cm</td> -->
            <td>保留小数点后2位</td>
        </tr>
        <tr style="height: 67px; ">
        ...
        <tr style="height: 67px; ">
            ...
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$ld1}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$ld2}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$ld3}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$ld4}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$ld5}}</td>
            <!-- <td>cm</td> -->
            <td>保留小数点后2位</td>
        </tr>
        <tr style="height: 67px; ">
            ...
            <td>
                <div>
                    <img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105200231.png"/>
                </div>
            </td>
            <td colspan="5" style="width: 262px; word-wrap:break-word; word-break:break-all; ">{{$l6}}</td>
            <!-- <td><img src="https://gitee.com/adya/images/raw/master/img/20210903152032.png "></td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; "></td>
            <td>cm</td> -->
            <td>保留小数点后2位</td>
        ...
        <tr style="height: 67px; ">
            ...
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$tt1}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$tt2}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$tt3}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$tt4}}</td>
            <td style="width:39px; word-wrap:break-word; word-break:break-all; ">{{$tt5}}</td>
            <!-- <td>cm</td> -->
            <td>保留小数点后3位</td>
        </tr>
        <tr style="height: 67px; ">
            <td>7</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/T.jpg"/></td>
            <td colspan="5" style="width: 262px; word-wrap:break-word; word-break:break-all; ">{{$t6}}</td>
            <!-- <td>s</td> -->
            <td>保留小数点后3位</td>
        </tr>
        <tr style="height: 67px; ">
            <td>8</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105195558.png"/></td>
            <td colspan="5" style="width: 262px; word-wrap:break-word; word-break:break-all; ">{{$g}}</td>
            <!-- <td>m/s2</td> -->
            <td>保留4位有效数</td>
        </tr>
    </table>
    <br>
    <div style="height: 63px; margin-right: 50px; font-size: 20px; font-weight: 400; "> 2.有效数处理与误差计算</div>
    <table border="1 " cellspacing="0 " style="width: 675px; " class="two ">
        <tr>
            <th>误差类别</th>
            <th>误差计算项</th>
        ...
        <tr>
            ...
            <td>摆长绝对误差平均值</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105202300.png"/></td>
        ...
        <tr>
            <td>摆长相对误差</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105202225.png"/></td>
        ...
        <tr>
            <td>振动周期绝对误差平均值</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105202041.png"/></td>
        ...
        <tr>
            <td>振动周期相对误差</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105201955.png"/></td>
        ...
        <tr>
            ...
            <td>g 的相对误差</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105201910.png"/></td>
        ...
        <tr>
            <td>g 的绝对误差</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105201709.png" style="width: 90px; height: 25px; "></td>
            <td style="width: 58px; word-wrap:break-word; word-break:break-all; ">{{$n6}}</td>
            <td><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105201601.png"/></td>
            <td>保留2位有效数</td>
        </tr>
    </table>
    <h3>六、实验结果与分析</h3>
    ...
    <div>
        <span style="float: left; margin-left: 50px; "><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105200741.png"/></span>
        <div style="float: left;height: 44px; margin-left: 60px; text-decoration:underline">
            <div style="font-size: 25px; font-weight: 100; margin-top: 0px; padding-left: 0px; ">
                <span style="word-wrap:break-word; word-break:break-all;">{{$y1}}</span>
                <span style="margin-left: 7px;">±</span>
                <span style="margin-left: 7px;">{{$y2}}</span>
                <span style="margin-left: 7px;"><img src="https://gitee.com/i-lift-my-hair/image/raw/master/20211105200841.png" style="display: inline-block; margin-bottom: -15px; "></span>
            </div>
        </div>
    </div>
    <br>
    <br>
    <br>
    <div style="margin-bottom: 5px; ">2.测量周期T时,需要连续测量多个周期,这是为了( {{$xz1}} ).</div>
    <div style="margin-bottom: 5px; ">A.减少人为偶然误差;B.减少系统方法误差;C.延长测量时间;</div>
    <br>

    <div style="margin-bottom: 5px; ">3.一个单摆在做简谐运动,下列说法正确的是( {{$xz2}} ).</div>
