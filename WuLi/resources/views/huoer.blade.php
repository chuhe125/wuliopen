...
<h3>五、实验内容与步骤</h3>
    ...
    <div style="margin-top:10px">3.打开<img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081804785.png" alt="" style="vertical-align: middle">,<img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081803734.png" alt="" style="vertical-align:middle">开关，调整 <img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081804785.png" alt="" style="vertical-align: middle">=5.00mA,<img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081803734.png" alt="" style="vertical-align:middle">=300mA。移动y轴，找到<img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081810305.png" alt="" style="vertical-align:middle"> 输出最大点。</div>
...
<h3>六、实验注意事项</h3>
        ...
        <h3>七、数据记录 分数:{{$grade_tk}}</h3>
                <div style="margin-bottom: 10px;">
                    实验中给定 :
                    <img src="https://gitee.com/adya/images/raw/master/img/20211011162455.png" alt="" style="vertical-align: middle;">
                </div>
                <div style="height:40px;line-height: 40px;margin-bottom: 20px;">
                    实验仪器编号：_____{{$number}}_____ ；线圈常数= _____{{$constant}}_____
                    <img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081758372.png" alt="" style="vertical-align: middle;">
                </div>
                <div style="font-size: 13px;text-align: center;">表1.电磁铁气隙中磁感应强度 的分布（<img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081803734.png" alt="" style="vertical-align:middle">=300MA, <img src="https://gitee.com/cuckoo-of-life/noteimg/raw/master/img/202109081804785.png" alt="" style="vertical-align: middle">=5.00MA）</div>
                <table cellpadding="5" cellspacing="0" style="margin: 0 auto;width:556px;border:0.1px solid black;">
                    ...
                    <tr>
                        ...
                        <td class="tds">{{$a3}}</td>
                        <td class="tds">{{$a4}}</td>
                        <td class="tds" colspan="3">{{$a5}}</td>
                        <td class="td9 tds">{{$a6}}</td>
                    </tr>
                    <tr>
                ...
                <div class="img" style="text-align: center;">
                    <img src="{{$tu}}
                    " alt="" style="vertical-align: middle;padding:10px;max-width:536px;height: auto;">
                </div>



        <h3>七、思考题 分数:{{$grade_xp}}</h3>

                <div style="text-indent: 2em;margin-bottom: 10px;">1.若磁感应强度 B 与元件平面法线存在角度 α 时，作用在元件上的有效磁场大小为：（ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$xz1}}）</div>
                ...
                <div style="text-indent: 2em;margin-bottom: 10px;">2.若磁感应强度 B 与工作电流方向存在角度 β 时，作用在元件上的有效磁场大小为：（ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$xz2}} ）</div>
