...
Route::prefix('bridge') -> group(function(){
    ...
    Route::post('completion','BridgeController@completion');//实验2答题
    Route::get('pdf','BridgeController@pdf');//实验2pdf
...
Route::prefix('excel')->group(function (){
    Route::get('put','ExcelController@export');
});
/**
 * @author oys
 */
Route::prefix('completion15')->group(function (){
    Route::post('experiment15','Completion15Controller@completion15');//实验15答题
    Route::get('pdf15','Completion15Controller@pdf15');//实验pdf
});
/**
 * @Author: wzh
 */
    Route::get('findall','AdminController@findall');
    Route::post('change','AdminController@test');
